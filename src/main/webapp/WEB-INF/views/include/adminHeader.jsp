...
<div class="header header5">
	<div class="header-top">
			...
			<div class="container">			
				<div class="logo">
					<h1><a href="index.html">A<span>dministrator</span></a></h1>
				</div>
			<c:catch>
				<c:choose>
			...
			<div class="top-nav">
				<ul class="memenu skyblue">
					<li><a href="/">HOME</a></li>
					<li><a href="/admin/umlistPage">MEMBER</a></li>
					<li class="grid"><a href="#">Menu</a>
						<div class="mepanel">
							<div class="row">
								<div class="col1 me-one">
									<h4>Menu</h4>
									<ul>
										<li><a href="/admin/listMenu">Menu</a></li>
						    			<li><a href="/admin/listReviews">Review</a></li>
									</ul>
								</div>
							</div>
						</div>
					</li>
					<li><a href="/admin/listReservation">RESERVATION</a></li>
					<li><a href="/admin/listFAQ">FAQ</a></li>
